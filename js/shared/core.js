...
function isOfficeMealUser(u){
  ...
  // ✅ NEW (2026-09-12): তৃতীয়-পক্ষের (থার্ড পার্টি) ব্যক্তিদের জন্য
  // সদস্য-সম্পাদনা ফর্মে সরাসরি "🏢 অফিস" টাইপ বেছে নেওয়া যায় — তখন
  // _office flag বসে না, বরং u.type==='office' হয়। MPCL/MEPL-এর পুরনো
  // _office:true পদ্ধতি অপরিবর্তিত রাখা হলো (ওই স্ক্রিন ছোঁয়া হয়নি) —
  // দুটো পদ্ধতিই এখানে সমানভাবে চেনে, যাতে সব বিলিং/রিপোর্ট লজিক (যেগুলো
  // এই ফাংশনটাই চেক করে) কোনো পরিবর্তন ছাড়াই দুই ক্ষেত্রেই ঠিকভাবে কাজ করে।
  return !!(u && (u._office || u.type==='office'));
}
